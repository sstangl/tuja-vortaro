...
["afero","asia, kysymys, asia, (voi tarkoittaa jotain konkreettistakin, jää usein kääntämättä erillisellä sanalla)"],
...
["alta","korkea (sävel), korkea, pitkä (ihminen, puu), korkea(lla oleva), ylä-, suuri, korkea"],
...
["ankoraŭ","vielä, yhä, edelleen, vielä, vieläkin, lisäksi"],
...
["ja","kyllä (vahvistussana), -han, -hän, toki, tosin, -han, -hän"],
...
["kakao","kaakaopapu, kaakao, kaakao"],
["kakatuo","kakadu"],
["kakaujo","kaakaopuu"],
...
["kalendaro","ajanlasku, kalenteri, kalenteri, almanakka"],
...
["li","hän, hän (miespuolinen), tuo mies, tuo poika, hän"],
["lia","hänen ... -nsa, -nsä"],
...
["nuna","nykyinen"],
["nuntempo","nykyaika"],
["nur","vain, ainoastaan, vain, pelkästään, vasta"],
...
["troe","liikaa"],
["troigo","liioittelu"],
["tuj","heti, viipymättä, heti, aivan (lähellä)"],
...
["unu","yksi, yksi, yksi, toinen, eräs"],
